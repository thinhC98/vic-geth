...
func (r *Record) Set(e Entry) {
	...
	if err != nil {
		panic(fmt.Errorf("[ENR] enr: can't encode %s: %v", e.ENRKey(), err))
	}
	r.invalidate()
...
func (r *Record) SetSig(s IdentityScheme, sig []byte) error {
	...
	case s == nil && sig != nil:
		panic("[ENR] enr: invalid call to SetSig with non-nil signature but nil scheme")
	case s != nil && sig == nil:
		panic("[ENR] enr: invalid call to SetSig with nil signature but non-nil scheme")
